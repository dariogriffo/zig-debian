...
(.deb) for [Zig](https://github.com/ziglang/zig) hosted at [deb.griffo.io](https://deb.griffo.io)
...
> the .deb from the [Releases](https://github.com/dariogriffo/zig-debian/releases) page
