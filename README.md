...
📖 **Step-by-step install guide:** [Debian](https://debian.griffo.io/install-latest-zig-in-debian.html) · [Ubuntu](https://debian.griffo.io/install-latest-zig-in-ubuntu.html)
